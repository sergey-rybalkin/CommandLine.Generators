...
public class CommandParameterModelTests
{
    ...
    [Test]
    public async Task Equals_returns_false_when_parameter_name_differs()
    {
    ...
    [Test]
    public async Task Equals_returns_false_when_parameter_type_name_differs()
    {
    ...
    [Test]
    public async Task Equals_returns_false_when_value_hint_differs()
    {
    ...
    [Test]
    public async Task Equals_returns_false_when_alias_differs()
    {
    ...
    [Test]
    public async Task Equals_returns_true_when_all_optional_fields_are_null_or_default()
    {
    ...
    [Test]
    public async Task Get_hash_code_returns_different_value_for_different_models()
    {
        CommandParameterModel a = CreateModel(parameterName: "foo");
        CommandParameterModel b = CreateModel(parameterName: "bar");
